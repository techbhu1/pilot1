...
rh.consts('DEFAULT_TOPIC', encodeURI("#OmniSwitch_AOS_CLI_Reference_Guide/OmniSwitch_AOS_CLI_Reference_Guide/OmniSwitch_AOS_CLI_Reference_Guide.htm".substring(1)));
rh.consts('HOME_FILEPATH', encodeURI("index.html"));
rh.consts('START_FILEPATH', encodeURI('index.html'));
rh.consts('HELP_ID', 'A2BEB7A4-BD5C-4D8C-831F-20B243AD0F3B' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "CLI Reference Guide");
